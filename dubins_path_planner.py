...
def main():
    ...
    start_x2 = 1.0  # [m]
    start_y2 = -1.0  # [m]
    start_yaw2 = np.deg2rad(20.0)  # [rad]

    end_x2 = 2.7  # [m]
    end_y2 = 1.0  # [m]
    end_yaw2 = np.deg2rad(0.0)  # [rad]

    curvature2 = 1

    path_x2, path_y2, path_yaw2, mode2, lengths2 = plan_dubins_path(start_x2,
                                                               start_y2,
                                                               start_yaw2,
                                                               end_x2,
                                                               end_y2,
    ...
    if show_animation:
        plt.plot(path_x, path_y, label="Agressive 50")
        plt.plot(path_x2, path_y2, label="Agressive 80")
        plot_arrow(start_x, start_y, start_yaw)
        plot_arrow(end_x, end_y, end_yaw)
